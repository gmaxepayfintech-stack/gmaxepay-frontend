...
import { logOut, notificationIconMarksAsReadCompany, notificationIconDataCompany } from "../../redux/action/loginAction";
...
const WhiteLabelDashboardLayout = ({ children }) => {
  ...
  const handleNotificationClick = () => {
    ...
    if (!isNotificationOpen) {
      dispatch(notificationIconDataCompany());
      dispatch(notificationIconMarksAsReadCompany());
    }
  };
