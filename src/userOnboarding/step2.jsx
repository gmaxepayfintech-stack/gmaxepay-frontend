          ...
          <div className="mb-2.5 sm:mb-3 md:mb-3.5 lg:mb-3 xl:mb-4">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-0">
              ...
              <button
                ...
                className={`bg-[#039155] text-white rounded-lg sm:rounded-r-lg sm:rounded-l-none border-2 sm:border-l-0 border-gray-300 w-[110px] sm:w-[120px] md:w-[130px] lg:w-[140px] xl:w-[150px] text-xs sm:text-xs md:text-sm lg:text-sm xl:text-base font-semibold h-10 sm:h-10 md:h-11 lg:h-14 xl:h-14 hover:bg-green-700 hover:border-gray-400 transition whitespace-nowrap flex-shrink-0 shadow-md flex items-center justify-center ${verifuSuccess === "SUCCESS" && successCooldown > 0
