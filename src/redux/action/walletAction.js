...
// export const uploadLogo = (payload) => async (dispatch) => {
//     dispatch({ type: LOADING_START });
//     try {
//         const authToken = secureLocalStorage.getItem("userToken");
//         const response = await axios.post(
