...
import { PAYOUT_BANK_LIST_SUCCESS, PAYOUT_BANK_LIST_FAILURE, PAYOUT_TRANSACTION_SUCCESS, PAYOUT_TRANSACTION_FAILURE, COMPANY_PAYOUT_BANK_LIST_SUCCESS, COMPANY_PAYOUT_BANK_LIST_FAILURE, COMPANY_PAYOUT_TRANSACTION_SUCCESS, COMPANY_PAYOUT_TRANSACTION_FAILURE } from "../actionType/payOutType";
...
export const payoutCompanyBankList = (payload) => async (dispatch) => {
    ...
    try {
        ...
        const { data: payoutCompanyBankList, status, message } = response?.data ?? {};
        if (status === "SUCCESS") {
            dispatch({
...
export const payoutCompanyTransaction = (payload) => async (dispatch) => {
    ...
    try {
        ...
        const { data: payoutCompanyTransaction, status, message } = response?.data ?? {};
        if (status === "SUCCESS") {
            dispatch({
