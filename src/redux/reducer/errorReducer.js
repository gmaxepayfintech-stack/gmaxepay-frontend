...
import { FIND_MOBILE_OPERATOR_FAILURE, FIND_MOBILE_RECHARGE_OFFERS_FAILURE, FIND_MOBILE_RECHARGE_PLAN_FAILURE, PAY_RECHARGE_FAILURE } from "../actionType/rechargeActionType";
...
const errorReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case FIND_MOBILE_RECHARGE_OFFERS_FAILURE:
