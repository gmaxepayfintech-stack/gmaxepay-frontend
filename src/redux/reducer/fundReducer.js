...
const initialState = {
    ...
    employeeGetRequest: null,
    employeeApprove: null,
};
    ...
    switch (action.type) {
        ...
        case EMPLOYEE_REQUEST_SUCCESS:
            return {
                ...
                success: action?.payload?.status,
                message: action?.payload?.message,
                employeeGetRequest: action?.payload,
            }
        ...
        case EMPLOYEE_APPROVE_SUCCESS:
            return {
                ...
                success: action?.payload?.status,
                message: action?.payload?.message,
                employeeApprove: action?.payload,
            }
