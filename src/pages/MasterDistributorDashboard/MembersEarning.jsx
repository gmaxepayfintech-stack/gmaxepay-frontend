...
const MembersEarning = ({ embedded = false }) => {
    ...
    return (
        <div className={`text-[#1B1717] ${embedded ? '[&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]' : ''}`}>
            {/* Filter Section */}
            <div className="bg-white rounded-[24px] mb-6 sm:mb-8 shadow-sm border border-gray-200 w-full h-[164px] relative">
                <div className="absolute inset-0 flex flex-col items-center justify-center px-[18px]">
                    <h3 className="text-[20px] font-['Gilroy-SemiBold'] text-[#1B1717] mb-6 text-left w-full">
                        Add Filter
                    </h3>
...
MembersEarning.propTypes = {
    embedded: PropTypes.bool,
};

export default MembersEarning;
