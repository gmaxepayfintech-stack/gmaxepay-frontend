...
const DTHReport = ({ onBack }) => {
  ...
  const handleExportToExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, "DTH_Recharge_1_History");

    const fileName = `DTH_Recharge_1_History_Export_${new Date().toISOString().split("T")[0]}.xlsx`;
