...
import { FaCheckCircle, FaTimesCircle, FaUser, FaIdCard, FaBuilding, FaUniversity, FaExpand } from "react-icons/fa";
import { kycData as kycDataAction, kycStatusCheck, kycUnlock, useList as useListAction, kycRevert, rescendOnboarding, deActiveOnboarding } from "../../redux/action/whiteLabelAction";

const MasterDistributionOnboarding = ({ embedded = false, tableData: propTableData = [] }) => {
