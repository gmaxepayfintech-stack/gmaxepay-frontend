            ...
            <tbody className="bg-white divide-y divide-[#1B1717]/20">
              {servicesData.map((service, index) => (
                ...
                >
                  ...
                  <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-right">
                    <span className="text-[10px] font-['Gilroy-Regular'] text-[#039155]">
                      {service.success.toLocaleString()}
                    </span>
                  </td>
                  <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-right">
                    <span className="text-[10px] font-['Gilroy-Regular'] text-[#D66000]">
                      {service.pending.toLocaleString()}
                    </span>
                  </td>
                  <td className="px-4 sm:px-6 py-3 sm:py-4 whitespace-nowrap text-right">
                    <span className="text-[10px] font-['Gilroy-Regular'] text-[#E32424]">
                      {service.failed === 0
                        ? "000"
