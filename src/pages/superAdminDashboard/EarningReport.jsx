...
const EarningReport = ({ embedded = false }) => {
    ...
    const totals = servicesData.reduce(
        (acc, service) => ({
            ...
            commissionGenerated: acc.commissionGenerated + service.commissionGenerated,
            commissionPaid: acc.commissionPaid + service.commissionPaid,
            commission: acc.commission + service.commission,
        }),
        { txnVolume: 0, txnCount: 0, success: 0, commissionGenerated: 0, commissionPaid: 0, commission: 0 }
    );
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-[28px]">
                    ...
                    <p className="text-[16px] sm:text-base md:text-lg text-[#1B1717] font-['Gilroy-Regular']">
                        This Earning Report Provides Showcasing Revenue Streams, Profitability Of Your Business.
                    </p>
                </div>
                ...
                <div className="mb-6 sm:mb-8">
                    <div className="inline-flex bg-[#FFFFFF] w-[527px] h-[68px] rounded-xl px-[18px] py-[14px] gap-[146px]">
                        <button
                            ...
                            className={`w-[148px] h-[40px] py-[10px] px-[14px] rounded-2xl font-medium transition-all flex items-center justify-center gap-2.5 ${activeTab === "myEarning"
                        ...
                        <button
                            ...
                            className={`w-[197px] h-[39px] py-[10px] px-[14px] rounded-2xl font-medium transition-all flex items-center justify-center gap-2.5 ${activeTab === "membersEarning"
                                ? "text-white bg-[#039155] shadow-sm"
                                : "text-gray-700 hover:text-gray-900"
                                }`}
                        >
