        ...
        <div className="min-h-screen  p-4 sm:p-6 text-[#1B1717]">
            ...
            <div className="mb-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                    <div>
                        ...
                        <p className="text-lg sm:text-base text-[#1B1717] ">
                            Manage And Monitor All Your Membership Programs
                        </p>
                    </div>
                    <button
                        onClick={() => setIsModalOpen(true)}
                        className="flex items-center justify-center gap-2 bg-[#039155] text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg font-medium hover:bg-green-700 transition shadow-md"
                    >
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm  mb-6">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mb-6">
                    ...
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#039155] focus:border-[#039155]"
                        />
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                        {filters.map((filter) => (
                            <button
                                ...
                                className={`px-4 py-3 rounded-xl text-md font-medium transition ${activeFilter === filter
                ...
                {schemes.map((scheme) => {
                    ...
                    return (
                        <div
                            key={scheme.id}
                            className="bg-white rounded-xl border border-[#1B1717] border-opacity-40 shadow-sm p-4 sm:p-6 hover:shadow-md transition-shadow"
                        >
                            {/* Card Header */}
                            <div className="flex items-start justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-lg ${scheme.useImage ? '' : scheme.iconBg} flex items-center justify-center`}>
                                        {scheme.useImage ? (
                                            <img
                                            ...
                                            <IconComponent className={`w-5 h-5 sm:w-6 sm:h-6 ${scheme.iconColor}`} />
                                        )}
                                    </div>
                                    <div>
                                        <h3 className="text-md sm:text-lg font-medium text-[#1B1717] mb-1">
                                            {scheme.name}
                                        </h3>
                                        {/* Tags */}
                                ...
                                {/* Status Indicator */}
                                <div className="flex items-center bg-[#008D1E] rounded-full p-2 px-3 gap-1.5">
                                    <div className="w-2 h-2 rounded-full bg-white"></div>
                                    <span className="text-xs font-medium  text-white">{scheme.status}</span>
                                </div>
                            </div>
                            ...
                            {/* View Details Button */}
                            <button className="w-full bg-[#039155] text-white py-4 rounded-lg font-medium hover:bg-green-700 transition text-md sm:text-base">
                                View Details
                            </button>
                        </div>
                    );
            ...
            {isModalOpen && (
                ...
                >
                    ...
                    >
                        {/* Modal Header */}
                        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-5 flex items-start justify-between rounded-t-xl z-10">
                            <div className="flex-1 pr-4">
                                <h2 className="text-xl sm:text-2xl font-semibold text-[#1B1717] mb-1.5">
                            ...
                            <button
                                onClick={() => setIsModalOpen(false)}
                                className="flex-shrink-0 w-8 h-8 rounded-full bg-[#039155] text-white flex items-center justify-center hover:bg-green-700 transition flex-shrink-0"
                            >
                                <X className="w-4 h-4" />
                            </button>
                        </div>
                        ...
                        <div className="sticky bottom-0 bg-white border-t border-gray-200 px-6 py-4 flex items-center justify-end gap-3 rounded-b-xl">
                            <button
                                onClick={() => setIsModalOpen(false)}
                                className="px-6 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition text-sm"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="px-6 py-2 bg-[#039155] text-white rounded-lg font-medium hover:bg-green-700 transition text-sm"
                            >
                                Create
                            </button>
                        </div>
