...
const ProfileDetails = ({ onBack }) => {
    ...
    return (
        <div className="min-h-screen bg-[#FAFAFA] text-[#1B1717]">
            ...
            {/* Profile Section */}
            <div className="bg-white px-6 sm:px-6 md:px-8 pb-6 sm:pb-8 pt-4 sm:pt-6">
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                    ...
                    <div className="flex-1 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:ml-[11rem]">
                        <div className="flex-1">
                            <h2 className="text-[16px] sm:text-2xl md:text-3xl font-['Gilroy-SemiBold'] text-[#000000] mb-3 sm:mb-4">
                                RUDRAA INITIATIVES
                            </h2>
                            <div className="flex flex-wrap items-center gap-[20px] sm:gap-4 mb-3 sm:mb-4">
                                <div className="flex items-center gap-[8px] text-sm sm:text-base text-[#1B1717] text-opacity-80">
                                    <img src={PhoneIcon} alt="Phone" className="w-[14px] h-[14px]" />
                                    <span>9740418525</span>
                                </div>
                                <div className="flex items-center gap-2 text-sm sm:text-base text-gray-600">
                                    <img src={EmailIcon} alt="Email" className="w-[14px] h-[14px]" />
                                ...
                                <span className="px-3 py-1 bg-[#158ACD] text-[#FFFFFF] rounded-full text-xs sm:text-sm font-medium">
                                    Whitelabel
                                </span>
                            </div>
                        </div>
                        ...
                        {/* Active Status */}
                        <div className="flex items-center gap-2 bg-[#008D1E] px-4 py-2 rounded-full">
                            <div className="w-3 h-3 bg-[#FFFFFF] rounded-full flex items-center justify-center">
                            </div>
                            <span className="text-[12px] sm:text-base font-['Gilroy-SemiBold'] text-[#FFFFFF]">Active</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-6 sm:mt-8">
                    <div className="bg-white border border-gray-200 rounded-3xl p-3 sm:p-4 flex items-center gap-3">
                        <img src={UserId} alt="User Id" className="w-[35px] h-[35px] sm:w-12 sm:h-12" />
                        <div>
                            <p className="text-[16px] text-[#1B1717] text-opacity-80 font-['Gilroy-SemiBold'] text-gray-500 mb-1">16007</p>
                            <p className="text-[14px] sm:text-sm font-['Gilroy-Medium'] text-[#1B1717] text-opacity-80">User Id</p>
                        </div>
                    </div>
                    <div className="bg-white border border-gray-200 rounded-3xl p-3 sm:p-4 flex items-center gap-3">
                        <img src={AgentCode} alt="Agent Code" className="w-[35px] h-[35px] sm:w-12 sm:h-12" />
                        <div>
                            <p className="text-[16px] text-[#1B1717] text-opacity-80 font-['Gilroy-SemiBold'] text-gray-500 mb-1">SECPY26007</p>
                            <p className="text-[14px] sm:text-sm font-['Gilroy-Medium'] text-[#1B1717] text-opacity-80">Agent Code</p>
                        </div>
                    </div>
                    <div className="bg-white border border-gray-200 rounded-3xl p-3 sm:p-4 flex items-center gap-3">
                        <img src={Pincode} alt="Pincode" className="w-[35px] h-[35px] sm:w-12 sm:h-12" />
                        <div>
                            <p className="text-[16px] text-[#1B1717] text-opacity-80 font-['Gilroy-SemiBold'] text-gray-500 mb-1">6007</p>
                            <p className="text-[14px] sm:text-sm font-['Gilroy-Medium'] text-[#1B1717] text-opacity-80">Pincode</p>
                        </div>
                    </div>
                    <div className="bg-white border border-gray-200 rounded-3xl p-3 sm:p-4 flex items-center gap-3">
                        <img src={Gst} alt="GST" className="w-[35px] h-[35px] sm:w-12 sm:h-12" />
                        <div>
                            <p className="text-[16px] text-[#1B1717] text-opacity-80 font-['Gilroy-SemiBold'] text-gray-500 mb-1">N/A</p>
                            <p className="text-[14px] sm:text-sm font-['Gilroy-Medium'] text-[#1B1717] text-opacity-80">GST</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Navigation Tabs */}
            <div className="bg-white rounded-xl shadow-sm px-4 sm:px-6 md:px-8 py-4 mt-4 sm:mt-6">
                <div className="flex items-center justify-between gap-4">
                    <button
                        type="button"
                        onClick={() => setActiveTab('membership')}
                        className={`text-sm sm:text-base font-medium transition-colors ${activeTab === 'membership'
                            ? 'text-white bg-[#039155] px-4 py-3 rounded-lg'
                            : 'text-gray-600'
                            }`}
                    >
                        Membership Scheme Upgrade / Personal Details
                    </button>
                    <button
                        type="button"
                        onClick={() => setActiveTab('kycDetails')}
                        className={`text-sm sm:text-base font-medium transition-colors ${activeTab === 'kycDetails'
                            ? 'text-white bg-[#039155] px-4 py-3 rounded-lg'
                            : 'text-gray-600'
                            }`}
                    >
                        KYC Details / Outlet Details
                    </button>
                    <button
                        type="button"
                        onClick={() => setActiveTab('bankDetails')}
                        className={`px-4 py-3 text-sm sm:text-base font-medium transition-colors rounded-lg ${activeTab === 'bankDetails'
                            ? 'text-white bg-[#039155]'
                            : 'text-gray-600'
                            }`}
                    >
                        Bank Details
                        ...
                        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4 sm:mb-6">
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">Rohan G</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">Aadhar Number</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">1234 4567 4568 ****</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">Upload Date</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">14-05-2022</p>
                                </div>
                                <div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div className="border-2 border-dashed border-gray-300 rounded-lg overflow-hidden bg-gray-50">
                                        <img src={aadhaarfront} alt="Aadhar Front" className="w-full h-48 sm:h-64 object-contain" />
                                    </div>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-2">Aadhar Back</p>
                                    <div className="border-2 border-dashed border-gray-300 rounded-lg overflow-hidden bg-gray-50">
                                        <img src={aadhaarback} alt="Aadhar Back" className="w-full h-48 sm:h-64 object-contain" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-4 sm:mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">DDG4568 ****</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">Upload Date</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">14-05-2022</p>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div className="border-2 border-dashed border-gray-300 rounded-lg overflow-hidden bg-gray-50">
                                        <img src={pancardfront} alt="Pan Front" className="w-full h-48 sm:h-64 object-contain" />
                                    </div>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-2">Pan Back</p>
                                    <div className="border-2 border-dashed border-gray-300 rounded-lg overflow-hidden bg-gray-50">
                                        <img src={pancardback} alt="Pan Back" className="w-full h-48 sm:h-64 object-contain" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4 sm:mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">Rajaji Nagar Near Metro Station</p>
                                </div>
                            </div>
                            <div>
                        ...
                        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">RUDRAA INITIATIVES MEDIA PRIVATE LIMITED</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">Mobile Number</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">9740418522</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">Email Id</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">Rudra@Gmail.Com</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">Agent Code</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">102212</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">GST Number</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">Ghb1234</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">User ID</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">16007</p>
                                </div>

                                {/* Location and Profile Information */}
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">State</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">Karnataka</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">City</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">Bangalore</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">Pin Code</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">577006</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">Profile Expiry Date</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">Rudra@Gmail.Com</p>
                                </div>
                                <div>
                                ...
                                <div className="sm:col-span-2 lg:col-span-3">
                                    ...
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">501 Blue Mountain Building Malda East Mumbai</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">Latitude</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">15.0123049</p>
                                </div>
                                <div>
                                    <p className="text-xs text-gray-500 mb-1">Longitude</p>
                                    <p className="text-sm sm:text-base font-medium text-[#1B1717]">76.6158185</p>
                                </div>
                            </div>
                        </div>
                    </div>
