...
import MPOSTransactionDetails from "./MPOSTransactionDetails";
...
const MPOSReport = ({ onBack, apiType = "aeps1", transactionType = "CW" }) => {
    ...
    */
    ...
    const handleExportToExcel = () => {
        ...
        const excelData = filteredTransactions.map((row, index) => ({
            "SR No": index + 1,
            "Created At": row.formattedDateTime,
...
MPOSReport.propTypes = {
    onBack: PropTypes.func,
    apiType: PropTypes.string,
    transactionType: PropTypes.string,
};

MPOSReport.defaultProps = {
    onBack: null,
    apiType: "aeps1",
    transactionType: "CW",
};

export default MPOSReport;
