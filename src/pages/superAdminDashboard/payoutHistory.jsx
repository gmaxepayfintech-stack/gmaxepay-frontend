...
import { getPayoutHistory, payoutStatusCheckUser, payoutStatusCheckCompany } from "../../redux/action/payoutAction";
...
const PayoutHistory = ({ onBack, type }) => {
  ...
  const handleExportToExcel = async () => {
    ...
    try {
      ...
      const result = await getPayoutHistory(payload)(customDispatch);
