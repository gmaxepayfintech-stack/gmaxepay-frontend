...
const MATMTransactionDetails = ({ transactionData, onBack }) => {
...
MATMTransactionDetails.propTypes = {
    transactionData: PropTypes.object.isRequired,
    onBack: PropTypes.func,
};

MATMTransactionDetails.defaultProps = {
    onBack: null,
};

export default MATMTransactionDetails;
