...
import { rechargeReportTwoCompany, checkMobileRecharge2Status } from "../../../redux/action/reportAction";
...
const RechargeReportTwo = ({ onBack }) => {
    ...
    const handleCheckStatus = async (transaction) => {
        ...
        try {
            ...
            if (response?.status === "SUCCESS") {
                ...
                dispatch(rechargeReportTwoCompany(fetchPayload));
            } else {
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Recharge_History_2");

        // Dynamic filename with current date
        const fileName = `MobileRecharge2_History_Export_${new Date().toISOString().split("T")[0]}.xlsx`;
