...
import { rechargeReportTwoCompany, checkDth2Status } from "../../../redux/action/reportAction";
...
const DTHReportTwo = ({ onBack }) => {
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "DTH2_History");

        const fileName = `DTH2_Recharge_Export_${new Date().toISOString().split("T")[0]}.xlsx`;
...
DTHReportTwo.propTypes = {
    onBack: PropTypes.func,
};

DTHReportTwo.defaultProps = {
    onBack: null,
};

export default DTHReportTwo;
