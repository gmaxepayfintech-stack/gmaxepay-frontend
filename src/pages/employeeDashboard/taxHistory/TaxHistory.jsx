...
const TaxHistory = () => {
  ...
  if (showAepsHistory) {
    return (
      <AepsCWHistory
        ...
        onBack={() => navigate("/employeeDashboard/txn-history")}
      />
    );
  }
  ...
  if (showRechargeHistory) {
    return (
      <RechargeReport onBack={() => navigate("/employeeDashboard/txn-history")} />
    );
  }
  ...
  if (showRechargeHistoryTwo) {
    return (
      <RechargeReportTwo onBack={() => navigate("/employeeDashboard/txn-history")} />
    );
  }
              ...
              <div className="p-3 sm:p-4 md:p-5 flex-grow flex flex-col">
                ...
                <button
                  onClick={() => {
                    if (card.viewKey) {
                      navigate(
                        `/employeeDashboard/txn-history?view=${card.viewKey}`,
                      );
                    }
                  }}
