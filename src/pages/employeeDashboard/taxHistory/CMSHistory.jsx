...
const CMSHistory = ({ onBack }) => {
    ...
    try {
      ...
      const result = await cmsEmployeeHistory(payload)(customDispatch);
      let rawDocs = [];
      if (result) {
            ...
            <div className="mb-3 sm:mb-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 mb-2 sm:mb-3">
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                        ...
                        <button onClick={() => { setFromDate(""); setToDate(""); setSearchQuery(""); setStatusFilter("All"); setCurrentPage(1); setIsReloading(true); dispatch(cmsEmployeeHistory({ query: {}, customSearch: {}, options: { page: 1, paginate: itemsPerPage, sort: { createdAt: -1 } } })); }}
