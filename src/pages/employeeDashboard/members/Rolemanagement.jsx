...
const DUMMY_ROLEDATA = {
  Member: {
    ...
    write: true,
    children: [
      { id: 11, moduleName: "RETAILERS", read: true, write: true, parentId: 1 },
      { id: 12, moduleName: "DISTRIBUTORS", read: true, write: false, parentId: 1 },
    ],
  },
  Report: {
    id: 2,
    ...
    write: false,
    children: [
      { id: 21, moduleName: "TRANSACTION_REPORT", read: true, write: false, parentId: 2 },
    ],
  },
};
...
const Rolemanagement = () => {
  ...
  useEffect(() => {
    ...
    if (roleId) {
      // dispatch(getPermission(roleId)); // DISABLED for demo
    }
  ...
  // Update modules when roledata changes - Use dummy data for demo
  useEffect(() => {
    const dataToTransform = (roledata && Object.keys(roledata).length > 0) ? roledata : DUMMY_ROLEDATA;
    const transformedModules = transformModulesFromAPI(dataToTransform);
    setModules(transformedModules);
  }, [roledata]);

  // When updateRolesPermission succeeds, refetch permissions for current role - DISABLED for demo
  useEffect(() => {
    /*
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          onClick={(e) => {
                            ...
                            // Call API to update parent permission - DISABLED for demo
                            if (current.roleId && current.permissionId) {
                              ...
                              */
                              console.log(`Updated parent read permission for ${current.name} to ${newRead}`);
                            }
                          }}
                        ...
                        <button
                          onClick={(e) => {
                            ...
                            if (current.roleId && current.permissionId) {
                              ...
                              */
                              console.log(`Updated parent write permission for ${current.name} to ${newWrite}`);
                            }
                          }}
                              ...
                              <div className="flex items-center gap-[2px]">
                                <button
                                  onClick={(e) => {
                                    ...
                                    // Call API to update child permission - DISABLED for demo
                                    const roleId =
                                      perm.roleId ||
                                    ...
                                    if (roleId && perm.permissionId) {
                                      ...
                                      */
                                      console.log(`Updated child read permission for ${perm.category} to ${newRead}`);
                                    }
                                  }}
                                ...
                                <button
                                  onClick={(e) => {
                                    ...
                                    if (roleId && perm.permissionId) {
                                      ...
                                      */
                                      console.log(`Updated child write permission for ${perm.category} to ${newWrite}`);
                                    }
                                  }}
                                  className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                                    permission.write
