        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#D9D9D9CC]">
          <div className="bg-white w-[498px] rounded-3xl p-6 relative">
            ...
            <div className="flex justify-between gap-3 mt-8">
              ...
              <button 
                onClick={() => {
                  alert("New employee added successfully (Demo Mode)");
                  setIsAddModalOpen(false);
                }}
                className="w-1/2 bg-[#039155] text-white rounded-xl font-[Gilroy-Semibold] py-3 text-sm hover:bg-[#027a46] transition"
              >
                Add Employee
              </button>
            </div>
