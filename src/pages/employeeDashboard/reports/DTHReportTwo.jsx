...
import { rechargeReportsTwoEmployee, checkDth2Status } from "../../../redux/action/reportAction";
...
const DTHReportTwo = ({ onBack }) => {
    ...
    const handleExportToExcel = () => {
        ...
        const fileName = `DTH_History_Export_${new Date().toISOString().split("T")[0]}.xlsx`;
