      ...
      <div className="w-full h-full overflow-y-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        ...
        <div className="w-full p-0 mb-6 sm:mb-8">
          <div className="bg-white rounded-xl shadow-sm px-4 py-3 sm:px-6 sm:py-4 flex justify-center w-full">
            <nav className="flex flex-wrap items-center justify-center gap-x-6 sm:gap-x-11 lg:gap-x-[184px] gap-y-3 text-gray-600 font-[Gilroy-Medium] text-xs sm:text-sm lg:text-base">
              <button
                onClick={() => {
                  setActiveNav("Whitelabel");
                  setShowOnboardingList(false);
                }}
                className={`px-3 sm:px-4 py-1.5 rounded-xl font-[Gilroy-Medium] text-sm sm:text-base lg:text-lg ${activeNav === "Whitelabel"
              ...
              <button
                ...
                className={`px-3 sm:px-4 py-1.5 rounded-xl font-[Gilroy-Medium] text-sm sm:text-base lg:text-lg ${activeNav === "Master Distributor"
                    ? "bg-[#039155] text-white"
                    : "text-gray-600 hover:text-green-600"
                  }`}
              >
              ...
              <button
                ...
                className={`px-3 sm:px-4 py-1.5 rounded-xl font-[Gilroy-Medium] text-sm sm:text-base lg:text-lg ${activeNav === "Distributor"
                    ? "bg-[#039155] text-white"
                    : "text-gray-600 hover:text-green-600"
                  }`}
              >
              ...
              <button
                ...
                className={`px-3 sm:px-4 py-1.5 rounded-xl font-[Gilroy-Medium] text-sm sm:text-base lg:text-lg ${activeNav === "Retailers"
                    ? "bg-[#039155] text-white"
                    : "text-gray-600 hover:text-green-600"
                  }`}
              >
                  ...
                  <thead className="bg-white">
                    <tr>
                      {tableHeaders.map((header) => (
                        <th
                          key={header}
                          className="px-3 py-4 text-left font-[Gilroy-Medium] text-[14px] text-[#1B1717] tracking-wider whitespace-nowrap"
                        >
                          {header}
                        </th>
                      ))}
                  ...
                  <tbody className="bg-white divide-y font-normal divide-gray-100">
                    {!currentTableData || currentTableData.length === 0 ? (
                      ...
                      currentTableData.map((row, index) => (
                        ...
                        >
                          {/* ID */}
                          <td className="px-4 py-4 whitespace-nowrap font-[Gilroy-Regular ] text-[#121216] text-[14px]">
                            {row.id || "N/A"}
                          </td>
                          {/* User */}
                          <td className="px-4 py-4 whitespace-nowrap font-[Gilroy-Regular] text-[#121216] text-[14px]">
                          ...
                          {/* KYC Steps */}
                          <td className="px-4 py-4 whitespace-nowrap font-[Gilroy-Regular] text-[#121216] text-[14px] text-center">
                            {row.kycSteps || "0"}
                          </td>
                          {/* Main Wallet */}
                          <td className="px-4 py-4 whitespace-nowrap font-[Gilroy-Regular] text-[#121216] text-[14px] text-center">
