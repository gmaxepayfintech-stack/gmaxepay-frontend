        ...
        try {
          ...
          if (response?.status === "SUCCESS") {
            ...
            setModal({
              ...
              type: "success",
              transactionData: response?.cashWithdrawl || response?.data || null,
            });
        ...
        try {
          ...
          if (response?.status === "SUCCESS") {
            ...
            setModal({
              ...
              type: "success",
              transactionData: response?.balanceEnquiry || response?.data || null,
            });
        ...
        try {
          ...
          if (response?.status === "SUCCESS") {
            ...
            setModal({
              ...
              type: "success",
              transactionData: response?.miniStatement || response?.data || null,
            });
