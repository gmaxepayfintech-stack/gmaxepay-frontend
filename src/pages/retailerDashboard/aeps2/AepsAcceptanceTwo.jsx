...
const AepsAcceptanceTwo = () => {
    ...
    const terms = useMemo(() => [
            {
                ...
                body:
                    'By Clicking "I Agree" Below, You Confirm That You Are An Authorized Representative Of The Merchant Entity And Have The Legal Authority To Bind The Entity To These Terms.',
            },
            {
                title: "Biometric Data & Consent",
                body:
                    "You Acknowledge That AEPS Transactions Require The Capture Of Customer Biometric Data.",
            },
            {
                title: "Daily 2FA Requirement",
                body:
                    "Two-Factor Authentication (Biometric) Is Strictly Required Once Every 24 Hours To Maintain Active Agent Status.",
            },
        ],
        []
    );
    ...
    if (currentStep === "identityVerification" || showIdentityVerification) {
        return <IdentityVerificationTwo onBack={() => setShowIdentityVerification(false)} />;
    }
        ...
        <div className="w-full">
                    ...
                    {[
                        {
                            ...
                            icon: (
                                <img src={Mobile} alt="" className="w-6 h-6 text-[#FFFFFF]" aria-hidden="true" />
                            ),
                        },
                        {
                            title: "Bio Metric Auth",
                            desc: "The Capture Of Customer Biometric Data",
                            icon: <img src={Biometric} className="w-6 h-6 text-[#FFFFFF]" aria-hidden="true" />,
                        },
                        {
                            title: "Daily 2FA",
                            desc: "2FA Authentication Reset For Every 24 Hours",
                            icon: (
                                <img src={Daily2FA} alt="" className="w-6 h-6 text-[#FFFFFF]" aria-hidden="true" />
                            ),
                        },
                    ].map((c) => (
                        <div
            ...
            <div className="bg-[#FFFFFF] rounded-2xl p-6 mb-6">
                ...
                <div className=" text-[14px] text-[#1B1717] font-['Gilroy-Regular'] leading-relaxed">
                    ...
                    Aadhaar Enabled Payment System ("AEPS"), You Agree To Be Bound By These
