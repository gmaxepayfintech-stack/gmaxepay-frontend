           ...
           text-[20px] font-['Gilroy-Medium'] focus:outline-none"
                    ...
                    {step === "success" && (
                        <div className="relative rounded-xl border-2 border-[#2F80ED] p-6 overflow-visible shadow-sm">
                            {/* ===== U-Shaped Cutouts on All Four Edges ===== */}

                            {/* Top Edge - Left U-Shape (opens upward) */}
                            ...
                            {/* Top Edge - Right U-Shape (opens upward) */}
                            ...
                            {/* Bottom Edge - Left U-Shape (opens downward) */}
                            ...
                            {/* Bottom Edge - Right U-Shape (opens downward) */}
                            ...
                            {/* Left Edge - Top U-Shape (opens leftward) */}
                            ...
                            {/* Left Edge - Bottom U-Shape (opens leftward) */}
                            ...
                            {/* Right Edge - Top U-Shape (opens rightward) */}
                            ...
                            {/* Right Edge - Bottom U-Shape (opens rightward) */}
