...
import { retailerGetBanks, retailerFundLoad } from '../../../redux/action/fundAction';
                    ...
                    <div className="bg-white rounded-3xl shadow-sm p-[18px] sm:p-[18px] lg:p-[18px]">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                ...
                                {/* Payment Mode */}
                                <div>
                                    <label htmlFor="paymentMode" className="block mb-[8px] text-[14px] font-['Gilroy-Medium'] text-[#1B1717]">
                                        Payment Mode <span className="text-red-400 text-[12px]">*</span>
                                    </label>
                                    <select
                                        id="paymentMode"
                                        value={paymentMode}
                                ...
                                {/* Pay Date */}
                                <div>
                                    <label htmlFor="payDate" className="block text-[14px] mb-[8px] font-['Gilroy-Medium'] text-[#1B1717]">
                                ...
                                {/* Reference / UTR */}
                                <div>
                                    <label htmlFor="referenceNumber" className="block text-[14px] mb-[8px] font-['Gilroy-Medium'] text-[#1B1717]">
                            ...
                            {/* Pay Slip */}
                            <div>
                                <label htmlFor="paySlip" className="block text-[14px] mb-[8px] font-['Gilroy-Medium'] text-[#1B1717] mb-2">
                                    Pay Slip
                                </label>
                                <div
                            ...
                            {/* Remarks */}
                            <div>
                                <label htmlFor="remarks" className="block mb-[8px] text-[14px] font-['Gilroy-Medium'] text-[#1B1717] mb-2">
                                    Remarks
                                </label>
                                <textarea
                                    id="remarks"
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-[11px] font-['Gilroy-Medium'] text-gray-600 leading-tight">
                                                    Account Number:{" "}
                                                    <span className="text-[#1B1717]">{bank.accountNumber}</span>
                                                </p>
