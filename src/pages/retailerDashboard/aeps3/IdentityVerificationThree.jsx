...
import { aepsThreeStatusCheck, aepsThreeSubmitOTP, aepsThreeRescendOTP } from "../../../redux/action/aepsThreeAction";
import { ButtonLoader } from "../../../widgets/layout/loader";
import { HiArrowLeft } from "react-icons/hi2";
import { useNotification } from "../../../context/NotificationContext";
const OTP_LENGTH = 6;

const IdentityVerificationThree = ({ onBack }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await dispatch(aepsThreeSubmitOTP({ otp: otpValue }));
      console.log("aepsThreeSubmitOTP response:", response);
  ...
  const handleResendOTP = async () => {
    ...
    try {
      const response = await dispatch(aepsThreeRescendOTP());
      //console.log("aepsThreeRescendOTP response:", response);
...
IdentityVerificationThree.propTypes = {
  onBack: PropTypes.func,
};

export default IdentityVerificationThree;
