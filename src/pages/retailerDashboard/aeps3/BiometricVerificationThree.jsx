...
import { aepsThreeStatusCheck, aepsThreeBiometricSubmit } from "../../../redux/action/aepsThreeAction";
...
const BiometricVerificationThree = () => {
  ...
  useEffect(() => {
    ...
    console.log("📤 Dispatching aepsThreeBiometricSubmit with data:", {
      txtPidDataLength: requestData.txtPidData.length,
      isBase64: true,
    });

    dispatch(aepsThreeBiometricSubmit(requestData))
      .then((response) => {
        ...
        if (response?.status === "SUCCESS") {
          ...
          // console.log(
          //   "🔄 Calling aepsThreeStatusCheck after successful biometric verification...",
          // );
...
export default BiometricVerificationThree;
