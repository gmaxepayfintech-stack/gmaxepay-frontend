...
const CMSHistory = ({ onBack, apiType = "aeps1", transactionType = "CW" }) => {
    ...
    */
    ...
    const handleExportToExcel = () => {
        ...
        const fileName = `CMS_History_Export_${new Date().toISOString().split("T")[0]}.xlsx`;
...
CMSHistory.propTypes = {
    onBack: PropTypes.func,
    apiType: PropTypes.string,
    transactionType: PropTypes.string,
};

CMSHistory.defaultProps = {
    onBack: null,
    apiType: "aeps1",
    transactionType: "CW",
};
