          ...
          <div className="max-w-2xl mx-auto text-center relative">
            ...
            <div className={comingSoon ? "opacity-80 pointer-events-none select-none blur-sm" : ""}>
              ...
              <button
                ...
                className="mt-[24px] inline-flex items-center justify-center gap-3 bg-[#039155] hover:bg-[#027A47] text-white rounded-lg px-10 py-3 text-[14px] font-['Gilroy-Medium'] transition w-full max-w-[320px]"
              >
