          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            ...
            <button
              onClick={() => {
                ...
                dispatch(getPayoutHistoryUser(payload)).then((res) => {
                  if (res?.status === "SUCCESS") {
                    showNotification("Payout history refreshed successfully", "success");
                  } else {
                    showNotification(res?.message || "Failed to refresh payout history", "error");
                  }
                });
              }}
