  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div
          className={`rounded-xl p-6 lg:flex-[1.6] w-full lg:w-auto self-start ${
            step !== "summary" ? "bg-white border border-gray-200" : ""
          }`}
        >
          {step === "category" && (
                ...
                <div>
                  ...
                  <div className="relative" ref={dropdownRef}>
                    ...
                    >
                      <span
                        className={
                          selectedCategory === "Select" ? "text-gray-400" : ""
                        }
                      >
                        {selectedCategory}
                      </span>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[20px] font-['Gilroy-Medium']">
                      ₹
                    </span>
