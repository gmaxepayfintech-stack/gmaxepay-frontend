...
const MPOSTransactionDetails = ({ transactionData, onBack }) => {
...
MPOSTransactionDetails.propTypes = {
    transactionData: PropTypes.object.isRequired,
    onBack: PropTypes.func,
};

MPOSTransactionDetails.defaultProps = {
    onBack: null,
};

export default MPOSTransactionDetails;
