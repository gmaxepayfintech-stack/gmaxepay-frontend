...
import { recentAOneHistory } from "../../../../redux/action/rechargeAction";
import { dthAOneCustomerInfo, dthAOnePlanFetch, dthAOnePay } from "../../../../redux/action/rechargeAction";
                                    ...
                                    onSubmit={async (values, { setSubmitting }) => {
                                        ...
                                        try {
                                            ...
                                            const customerResponse = await dispatch(
                                                dthAOneCustomerInfo(customerPayload),
                                            );
                                            ...
                                            if (
                                                ...
                                                const planResponse = await dispatch(
                                                    dthAOnePlanFetch(customerPayload),
                                                );
...
AOneDthRecharge.propTypes = {
    onBack: PropTypes.func,
};

export default AOneDthRecharge;
