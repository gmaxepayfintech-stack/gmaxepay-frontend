...
import { PanAOneRequest } from "../../../../redux/action/fundAction";
...
const AOnePan = () => {
    ...
    useEffect(() => {
        const fetchRecentHistory = async () => {
            ...
            try {
                await dispatch(recentAOneHistory(payload));
            } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await dispatch(PanAOneRequest(payload));
            ...
            if (responseStatus === "FAILURE") {
                ...
                dispatch(recentAOneHistory({ query: { serviceType: "Pan2Service" }, options: { page: 1, limit: 10, sort: { id: -1 } } }));
