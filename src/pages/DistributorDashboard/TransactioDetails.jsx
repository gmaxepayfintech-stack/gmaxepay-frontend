      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="bg-[#039155] px-4 py-3 flex items-center gap-2">
            ...
            />
            <h3 className="text-white font-['Gilroy-Medium'] text-base sm:text-lg">
              User Details
            </h3>
          </div>
                ...
                {commissionData.length > 0 ? (
                  <>
                    ...
                    <tr className="bg-gray-50">
                      <td
                        colSpan="3"
                        className="px-4 py-3 text-sm font-['Gilroy-Medium'] text-[#1B1717] text-right"
                      >
                        Total Commission
                      </td>
                      <td className="px-4 py-3 text-sm font-['Gilroy-Medium'] text-[#039155]">
                  ...
                  <tr>
                    <td
                      colSpan="4"
                      className="px-4 py-3 text-sm font-['Gilroy-Regular'] text-gray-500 text-center"
                    >
