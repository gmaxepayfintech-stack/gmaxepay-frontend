...
const DTHReportTwo = ({ onBack }) => {
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "DTH_Recharge_2_History");

        const fileName = `DTH_Recharge_2_History_Export_${new Date().toISOString().split("T")[0]}.xlsx`;
