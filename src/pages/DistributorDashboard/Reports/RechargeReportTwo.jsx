...
import { rechargeReportsTwoUser, checkMobileRecharge2Status } from "../../../redux/action/reportAction";
...
const RechargeReportTwo = ({ onBack }) => {
    ...
    const handleCheckStatus = async (transaction) => {
        ...
        try {
            ...
            const response = await dispatch(checkMobileRecharge2Status(payload));
    ...
    const handleExportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, "Mobile_Recharge_2_History");

        const fileName = `Mobile_Recharge_2_History_Export_${new Date().toISOString().split("T")[0]}.xlsx`;
                      ...
                      API Message
                                ...
                                <tbody className="bg-white divide-y divide-gray-200">
                                    {paginatedTransactions.length === 0 ? (
                                        <tr>
                                            <td colSpan="20" className="px-4 py-8 text-center text-sm sm:text-base font-['Gilroy-Medium'] text-gray-500">
...
RechargeReportTwo.propTypes = {
    onBack: PropTypes.func,
};

RechargeReportTwo.defaultProps = {
    onBack: null,
};

export default RechargeReportTwo;
