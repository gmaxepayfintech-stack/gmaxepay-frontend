    ...
    const transformApiData = (dataArray) => {
        ...
        return dataArray.map((item, index) => {
            ...
            return {
                ...
                billerName: item.billerName || "N/A", billerId: item.billerId || "N/A",
                transactionId: item.referenceId || "N/A",
                refNo: item.utr || item.ackno || "N/A",
                amount: `₹${item.amount ?? 0}`, commission: item.commission ?? 0,
                openingWallet: item.openingWallet, closingWallet: item.closingWallet,
                debit: item.debit ?? 0, credit: item.credit ?? 0,
