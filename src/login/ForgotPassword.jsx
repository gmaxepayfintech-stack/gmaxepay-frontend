...
const ForgotPassword = () => {
  ...
  const handleSubmit = (values) => {
    ...
    setShowVerification(true); // Show VerificationCode component
  };
  ...
  return (
    <div className="min-h-screen font-Gilroy-Medium flex flex-col lg:flex-row bg-white overflow-hidden">
      {/* LEFT IMAGE SLIDER */}
